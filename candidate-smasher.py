...
for s,p,o in a.triples((s, p, None)):
    ...
    for s2,p2,o2 in a.triples((s1,p1,None)):
        ...
        #print(node_type_tuple)
        graph_type_list.append(node_type_tuple)
    #print("\n")

# for x in range(len(graph_type_list)) :
#     print(graph_type_list[x])
...
# df_graph=df_graph.T
# #     graph_type_dicts[s1]=node_type_tuple
# # df_graph_type = pd.DataFrame.from_dict(graph_type_dicts,orient='index')
# df_graph.to_csv('df_graph_type_dict.csv')        

for s,p,o in b.triples((None,p23,None)):
    ac.append(str(o))
def get_template_data(ac):
    a25_dicts={}
    a26_dicts={}
    a27_dicts={}
    templatetype_dicts={}
    ...
    return a25_dicts,a26_dicts,a27_dicts,templatetype_dicts
...
df = df.fillna(0)
df = df.reset_index()
#df.to_csv('template_dict.csv')
# print(df.hea())


count=0
# def get_graph(goal_dicts):
#     aw=[]
#     notate_dicts=[]
#     for k,v in goal_dicts.items():
#         oxcv=BNode(v)
#         for  s,p,o in a.triples((None, None, oxcv)):
#             for s2,p2,o2 in a.triples((s,RDF.type,None)):
#                 if str(o2) != cp25:
#                     print(o2)
#                     aw.append(o2)
#     print(tuple(aw))
...
# annotate_dicts=get_graph(goal_dicts)

# for k,v in annotate_dicts.items():
#     if k=='N49f000469175434cb6f3929b48afd712':
#         print(v)              
